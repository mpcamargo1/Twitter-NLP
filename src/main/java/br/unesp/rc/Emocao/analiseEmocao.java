 ...
 * @author marco
 */
public class analiseEmocao {
     DoccatModel model;

        
        public analiseEmocao(){
	...
	public void trainModel() {
		...
		try {
			dataIn = new FileInputStream(System.getProperty("user.dir") + "/emocao.txt");
	...
	public String classifyNewTweet(String tweet) {
		...
		if (category.equalsIgnoreCase("2")) {
			System.out.println("The tweet is happy");
                        return "Happy";
			...
			System.out.println("The tweet is neutral");
                        ...
                        System.out.println("The tweet is sad");
                        return "Sad";
                }
                return null;
	}
